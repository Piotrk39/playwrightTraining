...
export default class sampleTransaction {
    ...
    constructor(page) {
      ...
      this.kaylinHomenickContact = page.getByText('Kaylin Homenick');
    ...
    async createNewPayTransaction() {
      ...
      await expect(this.kaylinHomenickContact).toHaveText('Kaylin Homenick');
      await this.kaylinHomenickContact.click();
